...
<!-- JavaScripts -->
<script src="<?php echo e(asset('assets/js/vendor/modernizr.js')); ?>"></script>
</head>
<body>
		...
		<nav class="nav-holder style-1">
			<div class="container">
				<div class="mega-dropdown-wrapper">
					<!-- Logo -->
					<div class="logo">
						<a href="index.html"><img src="<?php echo e(asset('assets/images/logo-1.png')); ?>" alt=""></a>
					</div>
					<!-- Logo -->
					<!-- Search bar -->
					...
					<div class="navigation">
						<ul>
							<li class="<?php echo e(Request::is('/') ? 'active' : null); ?>"><a href="<?php echo e(Route('home')); ?>"><i class="fa fa-home"></i>Home</a></li>
							<li class="<?php echo e(Request::is('about') ? 'active' : null); ?>"><a href="<?php echo e(Route('about')); ?>"><i class="fa fa-files-o"></i>About</a></li>
							<li class="<?php echo e(Request::is('gallery') ? 'active' : null); ?>"><a href="<?php echo e(Route('gallery')); ?>"><i class="fa fa-files-o"></i>gallery</a></li>
							<li class="<?php echo e(Request::is('author') ? 'active' : null); ?>"><a href="<?php echo e(Route('author')); ?>"><i class="fa fa-file-text"></i>author</a></li>
							<li class="<?php echo e(Request::is('contact') ? 'active' : null); ?>"><a href="<?php echo e(Route('contact')); ?>"><i class="fa fa-fax"></i>contact</a></li>
						</ul>
					</div>				
					<!-- Navigation -->
				</div>
	    		...
	    		<div class="row">
		    		...
		    		<div class="col-lg-4 col-sm-4">
		    			<div class="footer-column logo-column">
		    				<a href="index-1.html"><img src="<?php echo e(asset('assets/images/logo-2.png')); ?>" alt=""></a>
		    				<p></p>
...
<script src="<?php echo e(asset('assets/js/contact-form.js')); ?>"></script>					
<script src="<?php echo e(asset('assets/js/bigslide.js')); ?>"></script>							
<script src="<?php echo e(asset('assets/js/3d-book-showcase.js')); ?>"></script>					
<script src="<?php echo e(asset('assets/js/turn.js')); ?>"></script>							
<script src="<?php echo e(asset('assets/js/jquery-ui.js')); ?>"></script>								
<script src="<?php echo e(asset('assets/js/mcustom-scrollbar.js')); ?>"></script>					
<script src="<?php echo e(asset('assets/js/timeliner.js')); ?>"></script>					
<script src="<?php echo e(asset('assets/js/parallax.js')); ?>"></script>			   	 
<script src="<?php echo e(asset('assets/js/countdown.js')); ?>"></script>	
<script src="<?php echo e(asset('assets/js/countTo.js')); ?>"></script>		
...
<script src="<?php echo e(asset('assets/js/prettyPhoto.js')); ?>"></script>			
...
</html<?php /**PATH D:\laravel_project\gatewaybooks\resources\views/frontend/master.blade.php ENDPATH**/ ?>