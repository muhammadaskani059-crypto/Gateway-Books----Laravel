        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="/uploads/{{ Auth::user()->user_img }}" width="160" height="160" alt="{{ Auth::user()->name }}"
                  class="user-image">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li
            class="{{ Request::is('admin/category') || Request::is('admin/category/create') ? 'active' : null  }} treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/category/create') ? 'active' : null }}"><a
                  href="{{ Route('category.create') }}"><i class="fa fa-circle-o"></i> Create Category </a></li>
              <li class="{{ Request::is('admin/category') ? 'active' : null }}"><a href="{{ Route('category.all') }}"><i
                    class="fa fa-circle-o"></i> View Category </a></li>
            </ul>
          </li>
          <li
            class="{{ Request::is('admin/author') || Request::is('admin/author/create') ? 'active' : null  }} treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/author/create') ? 'active' : null }}"><a
                  href="{{ Route('author.create') }}"><i class="fa fa-circle-o"></i> Create Author </a></li>
              <li class="{{ Request::is('admin/author') ? 'active' : null }}"><a href="{{ Route('author.all') }}"><i
                    class="fa fa-circle-o"></i> View Author </a></li>
            </ul>
          </li>
          <li
            class="{{ Request::is('admin/book') || Request::is('admin/book/create') ? 'active' : null  }} treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/book/create') ? 'active' : null }}"><a
                  href="{{ Route('book.create') }}"><i class="fa fa-circle-o"></i> Create Book </a></li>
              <li class="{{ Request::is('admin/book') ? 'active' : null }}"><a href="{{ Route('book.all') }}"><i
          ...
          <li class="{{ Request::is('admin/media') || Request::is('admin/media/create') ? 'active' : null  }} treeview">
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/media/create') ? 'active' : null }}"><a
                  href="{{ Route('media.create') }}"><i class="fa fa-circle-o"></i> Create Media </a></li>
              <li class="{{ Request::is('admin/media') ? 'active' : null }}"><a href="{{ Route('media.all') }}"><i
          ...
          <li class="{{ Request::is('admin/team') || Request::is('admin/team/create') ? 'active' : null  }} treeview">
            ...
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/team/create') ? 'active' : null }}"><a
                  href="{{ Route('team.create') }}"><i class="fa fa-circle-o"></i> Create Team </a></li>
              <li class="{{ Request::is('admin/team') ? 'active' : null }}"><a href="{{ Route('team.all') }}"><i
