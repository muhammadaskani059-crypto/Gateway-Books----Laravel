...
@section('main-content')
  <section class="content">
    ...
    <!-- SELECT2 EXAMPLE -->
    <!-- form start -->
    <form name="formEdit" id="formEdit" method="POST" action="{{ Route('author.update', $author->id) }}"
