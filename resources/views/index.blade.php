...
<main class="main-content">
		...
		<div class="item">
			@if($slider->media_img == 'No image found')
				<img src="{{ asset('uploads/no-img.png') }}" width="1349" height="516" alt="No image found">
			@else
				<img src="{{ asset('uploads/'.$slider->media_img) }}" width="1349" height="516" alt="{{ $slider->title }}">
			@endif
		</div>
		<!-- Item -->
		@empty
							...
							<div class="item">
								...
								<div class="detail-img">
									@if($upcoming_book->book_img == 'No image found')
										<img src="{{ asset('uploads/no-img.png') }}" width="112" height="156" alt="No image found">
									@else
										<img src="{{ asset('uploads/'.$upcoming_book->book_img) }}" width="112" height="156" alt="{{ $upcoming_book->title }}">
									@endif
								</div>
							</div>
							@empty
						...
						<ul id="release-thumb" class="release-thumb">
							...
							<li>
								<a data-slide-index="{{ $key }}" href="{{ Route('book.show', $upcoming_book->slug) }}">
									...
									@if($upcoming_book->book_img == 'No image found')
										<img src="{{ asset('uploads/no-img.png') }}" width="94" height="122" alt="No image found">
									@else
										<img src="{{ asset('uploads/'.$upcoming_book->book_img) }}" width="94" height="122" alt="{{ $upcoming_book->title }}">
									@endif
			    				...
			    				<div class="product-box">
			    					<div class="product-img">
										@if($downloaded_book->book_img == 'No image found')
											<img src="{{ asset('uploads/no-img.png') }}" width="132" height="197" alt="No image found">
										@else
											<img src="{{ asset('uploads/'.$downloaded_book->book_img) }}" width="132" height="197" alt="{{ $downloaded_book->title }}">
										@endif
			    					...
			    					<div class="product-detail">
			    						...
			    						<div class="aurthor-detail">
			    							<span><img src="{{ asset('assets/images/book-aurthor/img-01.jpg') }}" alt="">{{ $downloaded_book->author->title }}</span>
				...
				<div class="recomend-slider">
					...
					<div class="item">
						@if($recommended_book->book_img == 'No image found')
							<img src="{{ asset('uploads/no-img.png') }}" width="109" height="150" alt="No image found">
						@else
							<a href="{{ Route('book.detail', $recommended_book->slug) }}"><img src="{{ asset('uploads/'.$recommended_book->book_img) }}" width="109" height="150" alt="{{ $recommended_book->title }}"></a>
						@endif
					</div>
					<!-- Item -->
					@empty
											...
											<div class="s-product">
												<div class="s-product-img">
													@if($book->book_img == 'No image found')
														<img src="{{ asset('uploads/no-img.png') }}" width="145" height="209" alt="No image found">
													@else
														<img src="{{ asset('uploads/'.$book->book_img) }}" width="145" height="209" alt="{{ $book->title }}">
													@endif
												...
												<h6><a href="{{ Route('book.show', $book->slug) }}">{{ Str::limit($book->title, 15, '...') }}</a></h6>
													...
													<!-- Add To Cart -->
													<button type="button" class="btn btn-primary btn-xs btn-cart add-to-cart" data-id="{{$book->id }}"
												     data-name="{{ $book->title }}"
												     data-price="{{ (int) $book->price }}"
												     data-img="{{ $book->book_img == 'No image found' ? 'no-img.png' : $book->book_img }}">
					...
					<div class="col-lg-3 col-sm-12">
						<div class="aurthor-img">
							@if($author_feature->author_img == 'No image found')
								<img src="{{ asset('uploads/no-img.png') }}" width="243" height="344" alt="No image found">
							@else
								<img src="{{ asset('uploads/'.$author_feature->author_img) }}" width="243" height="344" alt="{{ $author_feature->title }}">
							@endif
						</div>
					</div>
					<!-- Aurthor -->
										...
										@if($key < 3)
											<li>
												@if($author_book->book_img == 'No image found')
													<img src="{{ asset('uploads/no-img.png') }}" width="89" height="119" alt="No image found">
												@else
													<img src="{{ asset('uploads/'.$author_book->book_img) }}" width="89" height="119" alt="{{ $author_book->title }}">
												@endif
		      ...
		      <div class="row">
		      	<!-- Blog -->
		            ...
		            <div class="blog-style-1">
			             <div class="post-box">
			                <div class="thumb"><img src="{{ asset('assets/images/blog/img-01.jpg') }}" alt=""></div>
			             ...
			             <div class="post-box">
			                <div class="thumb"><img src="{{ asset('assets/images/blog/img-02.jpg') }}" alt=""></div>
			             ...
			             <div class="post-box">
			                <div class="thumb"><img src="{{ asset('assets/images/blog/img-03.jpg') }}" alt=""></div>
			                ...
			                <li>
			                  	<div class="gallery-figure">
			                  		@if($gallery->media_img == 'No image found')
										<img src="{{ asset('uploads/no-img.png') }}" width="242" height="187" alt="No image found">
									@else
										<img src="{{ asset('uploads/'.$gallery->media_img) }}" width="242" height="187" alt="{{ $gallery->title }}">
									@endif 
